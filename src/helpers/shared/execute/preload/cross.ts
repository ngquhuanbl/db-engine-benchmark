...
export const execute = async (
  ...
  //#region Read by range
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readByRange(
        benchmarkCount,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
        addConsoleLog,
  ...
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readAll(
        benchmarkCount,
        datasetSize,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
  ...
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readFromEndSource(
        benchmarkCount,
        datasetSize,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
  ...
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readByIndex(
        benchmarkCount,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
        addConsoleLog,
  ...
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readByLimit(
        benchmarkCount,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
        addConsoleLog,
  ...
  {
    const { nTransactionSum, oneTransactionSum } =
      await PreloadDBExecutor.readByNonIndex(
        benchmarkCount,
        DEFAULT_READ_USING_BATCH,
        DEFAULT_READ_BATCH_SIZE,
        addConsoleLog,
